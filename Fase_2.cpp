...
void ingreso(int cremo){
	...
	void bannermotd(){
	cout<<"----------GRUPO 4----------"<<endl;
	cout<<"Marcos Fernando Morales Méndez         1290-22-14615"<<endl;
	cout<<"Francisco Javier Muñoz Aguilar         1290-22-13910"<<endl;
	cout<<"José Ignacio Pereira Quiñonez          1290-22-6800"<<endl;
	cout<<"Jorge Jose Hernandez FLores            1290-22-799"<<endl;
	cout<<"Diego José Flores Catavi               1290-22-8865 "<<endl;
